...
![CBL 산출 방법](./images/cbl-method.png)
...
- 사용량의 경우 **15분 단위**로 데이터가 수집되므로, **발령 시작 시간 ~ 발령 종료 시간의 차**를 계산해야 함

---

## Mid(3/5) 방식 (예시)

> 본 문서에서는 **Mid(3/5) 방식을 예시**로 CBL 산출 과정을 설명합니다.
> 실제 운영 환경에서는 Mid(8/10) 등 다양한 방식이 적용될 수 있습니다.
...
![표준편차 계산](./images/std-deviation.png)

---

## 계산 플로우

![CBL 계산 프로세스](./images/cbl-process.png)
