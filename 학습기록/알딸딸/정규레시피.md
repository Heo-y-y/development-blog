...
우선 **프로젝트 요구 사항**은 클라이언트 요청이 0을 누르면 논알콜, 1 ~ 9를 누르면 1 ~ 9인 칵테일,  10 ~ 19를 누르면 10 ~ 19인 칵테일 ~ 이렇게 쭉 이어지다가 30이상인 알코올 도수의 칵테일들을 그 뒤로 나오게 진행했습니다.
...
`PageInfo`에 앞에서 설명 한 `pageInfo.of()` 메서드에 `pages`를 넣어주고 할당했습니다.
