...
### 배경
여러 가지 술이나 음료를 Mix 해서 만든 술을 칵테일이라고 한다. 소맥도 칵테일에 속하고, 요즘 유행하는 하이볼도 마찬가지이다.

혼술 하는 사람들이 많이 늘어나고 있는데, 여러 가지 레시피를 제공해 주는 곳이 생각보다 없고 정보도 제각각이라 얻기 힘들다.

그래서 정규 레시피를 제공해 주며, 각자의 개성 있는 칵테일 레시피를 서로 공유하는 사이트를 만들어 소통할 수 있는 사이트를 만들기로 했다!
