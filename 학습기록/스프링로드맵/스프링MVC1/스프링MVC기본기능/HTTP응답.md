...
참고로 HTML이나 뷰 템플릿을 사용해도 HTTP 응답 메시지 바디에 HTML 데이터가 담겨서 전달된다. 여기서 보는 것은 정적 리소스나 뷰 템플릿을 거치지 않고, 직접 HTTP 응답 메시지를 전달하는 경우이다.
...
![스크린샷 2024-01-26 오후 10 54 42](https://github.com/Heo-y-y/development-blog/assets/112863029/5552591f-306f-4ba1-883e-82b17a1b0763)
