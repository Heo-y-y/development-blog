...
**Spring Boot**는 **Spring Framework의 모듈 중 하나**이다. 최도한의 구성 또는 거의 0에 가까운 구성으로 **독립 실행형 애플리케이션을 구축**하는 데 도움이 된다. 간단한 **Spring 앱**이나 **RESTful 서비스**를 개발하고자 할 때 유용하게 사용할 수 있다.
